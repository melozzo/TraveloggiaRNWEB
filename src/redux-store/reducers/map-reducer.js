import {SET_MAPS, SET_MAP, CREATED_MAP,  DELETED_MAP, UPDATED_MAP, IS_EMPTY_MAP } from './../actions/map-actions'
...
function mapReducer( state = initialState, action ){
     ...
     let idx;
      switch(action.type){
		...
		case DELETED_MAP:
			const deleted = maps.find( m=>m.MapID === action.deletedMap.MapID)
